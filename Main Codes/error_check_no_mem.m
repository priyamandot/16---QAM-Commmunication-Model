...
binary_vector = randi([0 1],1,60000);
...
figure;
plot(EbN0_dB_range, BER, 'bo-', 'LineWidth', 1.5, 'MarkerSize', 8, 'DisplayName', 'Simulated BER');
hold on;
...
% Plot the BER versus SNR
figure;
semilogy(EbN0_dB_range, BER, 'bo-', 'LineWidth', 1.5, 'MarkerSize', 8, 'DisplayName', 'Simulated BER');
hold on;
